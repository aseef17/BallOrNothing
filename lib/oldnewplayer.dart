...
class _NewPlayerState extends State<NewPlayer> {
  ...
  void pickImage(ch) async {
    ...
    if (ch == "YES") {
      print(
          "EDITING IMAGE ----------------------------------- BLBALABLABALBALABLABLBALABALBALA BALBAL BLAH");
      setState(() {
        nimg = true;
        imgp = path + "/" + t1.text;
        imaged = image;
  ...
  void inject() async {
    ...
    setState(() {
      ...
      // imagedx = File(cpath.path + "/" +widget.pld[0]["img"]);
      // edit = true;
      eors = "SAVE";
